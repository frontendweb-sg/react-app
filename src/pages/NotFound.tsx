...
import GirlImage from "@/assets/girl-character.png";
      ...
      <Box>
        <Container maxWidth="xs">
          <Typography variant="h1" mb={3}>
            {AppContent.pageNotFoundTitle}
          </Typography>
          <Typography sx={{ maxWidth: 350, lineHeight: 1.6 }} color="gray">
            {AppContent.pageNotFoundContent}
          </Typography>
        </Container>
        <Box>
          <Svg size={400} viewBox="0 0 480 360">
            <defs>
              <linearGradient
                id="BG"
                x1="19.496%"
            ...
            <path
              ...
              opacity="0.2"
            ></path>
            <image href={GirlImage} height="300" x="205" y="30"></image>
            <path
              fill="#FFAB00"
